...
{
	private static final long serialVersionUID = 67712094712787219L;

	/**
	 * Constructs a new protocol exception with the specified detail message. The cause is not initialized, and may
	 * subsequently be initialized by a call to {@link #initCause}.
	 *
	 * @param message
	 *            The source error. Used to generate an error message. The detail message is saved for later retrieval
	...
	/**
	 * Constructs a new protocol exception with the specified cause and a detail message of
